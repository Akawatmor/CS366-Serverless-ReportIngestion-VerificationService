...
**Github**: [https://github.com/Nattasak-Chonmanat/rescue-prioritization.git](https://github.com/Nattasak-Chonmanat/recue-prioritization.git)
...
* **Method:** GET  
* **Path:** /v1/prioritizations/incident/{incident\_id}  
* **Type:** Synchronous
...
* priorityLevel (string , optional, LOW / NORMAL/ HIGH / CRITICAL)  
* status (string, optional, PENDING / EVALUATED / RE\_EVALUATE / FAILED)  
* limit (integer, optional, default=20)  
* offset (integer, optional, default=0)  
* minScore (decimal, optional, กรองคะแนนตํ่าสุด)  
* maxScore (decimal, optional, กรองคะแนนสูงสุด)  
* sortBy (string, optional, score / date)  
...
NOTE: การอัพเดทการประเมินจะใช้ topic นี้ในการ publish ด้วย consumer ต้อง handle duplicate เอง
...
`“description”: “STRING”,`  
 "location": {  
      ...
      "district": "เbla bla bla",  
      "subdistrict": "bla bla bla,  
...
| ----- | ----- | ----- | ----- | ----- |
| request\_id | String | Y (PK) | อ้างอิง Rescue request service | REQ-123 |
| incident\_id | UUID | Y | อ้างอิง Incident | 52b627a9-1059-470a-aef6-8567e7d6d6e2 |
| evaluate\_id | UUID | Y  | รหัส evaluation | 0317b548-0cc1-497f-a3b5-fea068ea31ea |
| request\_type | String | Y | ประเภทของ request | Earthquake |
...
| people\_count | Integer | Y | จํานวนคนที่ต้องการความช่วยเหลือ | 4 |
| special\_needs | String\[ \] | Y | ความต้องการพิเศษ | \[“bedridden”, “children”\] |
...
| version | String | Y | Version ของ model | 1.0.0 |
